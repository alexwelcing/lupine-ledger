...
| `verifiedBy` | Claim → FormalProof | `proves` | Frozen PP-2 snapshot: 77 build-locked theorems; current repository inventory machine-generated (`lean-count.json`); ordering / isotonic / impossibility families |
